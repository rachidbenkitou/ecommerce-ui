...
export class AuthService {
  ...
  authUrl: string = environment.appUrl + '/auth';
  forgotPasswordUrl = environment.appUrl+ '/auth/forgotPassword';
  changeForgottenPasswordUrl: any =  environment.appUrl+ '/auth/confirmForgotPassword';
